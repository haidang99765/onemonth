...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "I love you " + (thePercent + 2900) + " and never stop at 3000, click this to see something surprise i want to show u first :>";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Thực ra không phải là có 3000 đâu, tình yêu là vô hạn đó';
document.querySelector('.Description .modal-body').innerHTML = 'Lục Hoàng Mai, anh yêu em nhiều lắmmmm <i class="fas fa-heart"></i> ';
